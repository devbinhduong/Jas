...
export default function () {
    ...
    utils.hooks.on('search-quick', (event, currentTarget) => {
        ...
        if (!document.querySelector('script[src="https://searchserverapi1.com/widgets/bigcommerce/init.js?api_key=7B6d5S7M5h"]')) {
            const script = document.createElement('script');
            script.src = 'https://searchserverapi1.com/widgets/bigcommerce/init.js?api_key=7B6d5S7M5h';
            script.async = true;
