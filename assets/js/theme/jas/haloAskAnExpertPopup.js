...
export default function (context) {
    ...
    console.log('haloAskAnExpertPopup', context);

    $(document).ready(function() {
        utils.api.getPage(context.themeSettings.halo_ask_an_expert_pagelink, {template: 'jas/ask-an-expert/halo-ask-an-expert-form'}, (err, response) => {
            if (err) return;
